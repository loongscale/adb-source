...
#ifndef WINVER				// Allow use of features specific to Windows NT 4 or later.
...
#define _WIN32_WINDOWS 0x0501 // Change this to the appropriate value to target Windows xp or later.
#endif
